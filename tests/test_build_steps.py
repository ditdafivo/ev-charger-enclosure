...
class BuildStepModelTests(unittest.TestCase):
    ...
    def test_enclosure_document_assigns_every_object_once(self) -> None:
        ...
        self.assertEqual(step_by_object["tambour_ceiling_panel"], 11)
        self.assertEqual(step_by_object["enclosure_tambour_door"], 10)
        ...
        self.assertEqual(step_by_object["left_tambour_bend_backer"], 6)
        self.assertEqual(step_by_object["right_tambour_bend_backer"], 6)
    ...
    def test_generated_scad_contains_step_controls_and_routing(self) -> None:
        ...
        self.assertIn('["enclosure_tambour_door", 10]', scad)
        ...
        self.assertIn('["tambour_ceiling_panel", 11]', scad)
